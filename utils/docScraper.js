...
function buildSearchUrls(question) {
  ...
  if (lowerQuestion.match(/\b(log|logging|debug|monitor|troubleshoot|trace|command|view|aio)\b/)) {
    urls.push(
      'https://developer.adobe.com/app-builder/docs/guides/app_builder_guides/application_logging/',
